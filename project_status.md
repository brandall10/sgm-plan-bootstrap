...
**Updated:** 2026-09-15
**Current state:** W01–W03 are integrated; W04 P1 is locally complete with recorded verification. Its target has no remote and remains unreviewed/unintegrated; see the reconciled results.
**Recommended next work:** Review the documentation-only P1A amendment. After acceptance/integration, `status-next` selects P1A before P2; this PR does not start execution.
...
- Versioned JSON is the canonical CLI interface; Markdown is optional presentation. This design amendment awaits implementation in W04 P1A.
