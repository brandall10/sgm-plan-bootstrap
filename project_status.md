...
**Updated:** 2026-09-15
**Current state:** W01–W03 are complete and integrated in `main`; W04 P1 is complete and verified locally in its separate synthetic target. No GitHub remote or PR is required for this automated-only trial.
**Recommended next work:** Begin W04 P2 when ready; keep its fresh recovery and independent verification separate from the completed P1 evidence.
