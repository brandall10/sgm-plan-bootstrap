...
**Updated:** 2026-09-15
**Current state:** W01–W03 are complete and integrated in `main`; W04 P1 is implemented and verified in its separate target, awaiting target PR delivery.
**Recommended next work:** Configure or authorize a remote for the target, push its P1 branch, and create the review PR before P2.
