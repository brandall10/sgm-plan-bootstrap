...
Delivery: [PR #1](https://github.com/brandall10/sgm-plan-bootstrap/pull/1), [PR #2](https://github.com/brandall10/sgm-plan-bootstrap/pull/2), and [PR #3](https://github.com/brandall10/sgm-plan-bootstrap/pull/3) merged; final integration is `main` at `3e7b60d`. Next: W01 is closed; W02 owns subsequent acceptance/history work.
