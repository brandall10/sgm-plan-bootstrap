...
Root status.md remains ignored and reconstructible. Before resetting it, move consequential findings, progress, decisions, and evidence links into project_status.md. Keep plans and specs free of duplicate progress checklists. Do not create status.md merely because a work item was selected for planning.
